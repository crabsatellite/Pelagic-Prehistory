...
public class Eurhinosaurus extends WaterAnimal implements GeoEntity {
    ...
    protected static final RawAnimation ANIM_DRY_OUT = RawAnimation.begin().thenLoop("dry-out");
    ...
    protected PathNavigation createNavigation(Level level) {
        WaterBoundPathNavigation nav = new WaterBoundPathNavigation(this, level);
    ...
    protected float getSoundVolume() {
        float factor = this.isInWater() ? 0.5F : 0.32F;
